...
const alertVariants = cva('flex items-start gap-3 w-full rounded-lg border px-4 py-3', {
  variants: {
    variant: {
...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  ({ className, children, variant, icon = setIcon(variant), title, description, onClose, ...props }, ref) => (
    <div
      ref={ref}
      role='alert'
